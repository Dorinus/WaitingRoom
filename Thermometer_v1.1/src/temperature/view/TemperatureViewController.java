...
import temperature.mediator.PropretyChangeSubject;
...
public class TemperatureViewController
{
   ...
   public TemperatureViewController(PropretyChangeSubject subject)
   {
      subject.addListener(this::reactToChange);
   }

   public void reactToChange(PropertyChangeEvent event){
    //  Platform.runLater(() ->        filterLabel.setValue(event.getNewValue()));
   }
